(function () {
  ...
  var LEVELS = [
    ...
    { cards: ["J3", "R2"], rows: ["........", "B..#.H..", "........"] },
    { cards: ["R2", "R5"], rows: ["B.....", ".WWWW.", ".....H"] },
    { cards: ["R3", "J2"], rows: ["B..S.H"] },
    { cards: ["J2", "J2"], rows: ["B#.#H"] },
    { cards: ["R5", "R1"], rows: ["B.....", ".W.W.H", "......"] },
    { cards: ["R4", "J3"], rows: ["B...W.H", "......."] },
    { cards: ["R2", "R5"], rows: ["B......", "...WWW.", ".....H."] },
    { cards: ["J3", "R2", "R1"], rows: ["B#..H#", "......"] },
    { cards: ["R5", "J2"], rows: ["B....S.H"] },
    { cards: ["R1", "J3"], rows: ["B....", ".W#H."] },
    { cards: ["R2", "R4", "J2"], rows: ["#.H.#", ".....", "B.S.W"] },
    { cards: ["J2", "J4"], rows: ["B#.#.#H"] },
    { cards: ["R4", "R3"], rows: ["B......H", ".WWWWW.."] },
    { cards: ["R4", "R1"], rows: ["B....", ".W..H"] },
    { cards: ["R5", "R1"], rows: ["B......", ".WWW.H."] },
    { cards: ["J2", "J3"], rows: ["B#.#.H"] },
    { cards: ["R3", "J2", "R2"], rows: ["B.....#H", ".WW.WW..", "........"] },
    { cards: ["R4", "R3"], rows: ["#......#", "B......H", "#......#"] },
    { cards: ["J2", "J2", "J2"], rows: ["B#.#.SH"] },
    { cards: ["R7", "R1"], rows: ["B.......", ".W.W.W.H"] },
    { cards: ["R1", "R4"], rows: ["....H...", "B..WWW.."] },
    { cards: ["J2", "R4"], rows: ["B#....H", "..WWW..", "......."] },
    { cards: ["R4", "R3", "J2"], rows: ["..#H#..", "B......", ".W.S.W."] },
    { cards: ["R5", "J3", "R1"], rows: ["B.......H", ".WW#WWW.."] },
  ];
